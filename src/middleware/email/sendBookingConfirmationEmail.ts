...
const SendBookingConfirmationEmail = async (
  ...
  try {
    let mailOptions = {
      ...
      to: hotelEmail,
      subject: "Prenotazione NCC Confermata con Successo",
                          ...
                          <th class="small-12 large-12 columns first last" style="Margin: 0 auto; color: #ffffff; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0 auto; padding: 0; padding-bottom: 16px; padding-left: 16px; padding-right: 16px; text-align: left; width: 564px;">
                            <table style="border-collapse: collapse; border-spacing: 0; padding: 0; text-align: left; vertical-align: top; width: 100%;">
                              <tbody>
                                <tr style="padding: 0; text-align: left; vertical-align: top;">
                                  <th style="Margin: 0; color: #ffffff; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; padding: 0; text-align: left;">
                                    <h2 class="text-center" style="Margin: 0; Margin-bottom: 10px; color: orange; font-family: Helvetica, Arial, sans-serif; font-size: 30px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; text-align: center; word-wrap: normal;">Prenotazione Confermata!</h2>
                                    <h5 class="text-center" style="Margin: 0; Margin-bottom: 20px; color: #4b4b4b; font-family: Helvetica, Arial, sans-serif; font-size: 17px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 20px; padding: 0; text-align: center; word-wrap: normal;">
                                      Gentile ${companyName},<br><br>
                                      La tua prenotazione NCC è stata confermata con successo!<br><br>
                                      <strong>Dettagli della prenotazione:</strong>
                                    </h5>
                                    <div style="background: #ffffff; border-radius: 10px; padding: 20px; margin: 20px 0; border: 1px solid #e0e0e0;">
                                      <table style="width: 100%; border-collapse: collapse;">
                                        <tr>
                                          <td style="padding: 10px 0; color: #4b4b4b; font-weight: bold; width: 40%;">Numero Ordine:</td>
                                          <td style="padding: 10px 0; color: #4b4b4b;">#${orderNumber}</td>
                                        </tr>
                                        <tr>
                                          <td style="padding: 10px 0; color: #4b4b4b; font-weight: bold;">Cliente:</td>
                                          <td style="padding: 10px 0; color: #4b4b4b;">${clientName}</td>
                                        </tr>
                                        <tr>
                                          <td style="padding: 10px 0; color: #4b4b4b; font-weight: bold;">Partenza:</td>
                                          <td style="padding: 10px 0; color: #4b4b4b;">${from}</td>
                                        </tr>
                                        <tr>
                                          <td style="padding: 10px 0; color: #4b4b4b; font-weight: bold;">Destinazione:</td>
                                          <td style="padding: 10px 0; color: #4b4b4b;">${to}</td>
                                        </tr>
                                        <tr>
                                          <td style="padding: 10px 0; color: #4b4b4b; font-weight: bold;">Data:</td>
                                          <td style="padding: 10px 0; color: #4b4b4b;">${appointmentDate}</td>
                                        </tr>
                                        <tr>
                                          <td style="padding: 10px 0; color: #4b4b4b; font-weight: bold;">Ora:</td>
                                          <td style="padding: 10px 0; color: #4b4b4b;">${appointmentTime}</td>
                                        </tr>
                                        <tr>
                                          <td style="padding: 10px 0; color: #4b4b4b; font-weight: bold;">Prezzo Totale:</td>
                                          <td style="padding: 10px 0; color: #f7b500; font-weight: bold; font-size: 18px;">€${totalPrice.toFixed(2)}</td>
                                        </tr>
                                      </table>
                                    </div>
                                    <h5 class="text-center" style="Margin: 0; Margin-bottom: 10px; color: #4b4b4b; font-family: Helvetica, Arial, sans-serif; font-size: 17px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; text-align: center; word-wrap: normal;">
                                      La prenotazione è stata inviata ai nostri driver. Riceverai una notifica non appena un driver accetterà la corsa.<br><br>
                                      Puoi monitorare lo stato della prenotazione dalla sezione "I miei ordini" nel tuo account.
                                    </h5>
                                  </th>
                                  <th class="expander" style="Margin: 0; color: #ffffff; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; padding: 0 !important; text-align: left; visibility: hidden; width: 0;"></th>
                                </tr>
